...
type RiderListSearchAndFiltersFormProps = {
    query: string;
    clearHref: string;
    className?: string;
};
...
export function RiderListSearchAndFiltersForm({
    query,
    clearHref,
    className,
}: Readonly<RiderListSearchAndFiltersFormProps>) {
                    ...
                    >
                        ...
                        >
                            <SheetHeader className="pr-8">
                                ...
                                <SheetDescription>
                                    Search riders and narrow the list.
                                </SheetDescription>
                            </SheetHeader>

                            <div className="flex-1 space-y-6 overflow-y-auto py-6">
                                <div className="space-y-2">
                                    <Label htmlFor="rider-list-search">Search</Label>
                                    <Input
                                        id="rider-list-search"
                                        name="q"
                                        defaultValue={query}
