...
export function OwnProfileForm({ fullName, email, phoneNumber }: Readonly<OwnProfileFormProps>) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <section className="space-y-4 rounded-xl border bg-card p-5">
        ...
        <OwnProfileForm fullName={fullName} email={email} phoneNumber={phoneNumber} />
      </section>
