...
type MerchantListSearchAndFiltersFormProps = {
    query: string;
    clearHref: string;
    className?: string;
};
...
export function MerchantListSearchAndFiltersForm({
    query,
    clearHref,
    className,
}: Readonly<MerchantListSearchAndFiltersFormProps>) {
                    ...
                    >
                        ...
                        >
                            <SheetHeader className="pr-8">
                                ...
                                <SheetDescription>
                                    Search merchants and narrow the list.
                                </SheetDescription>
                            </SheetHeader>

                            <div className="flex-1 space-y-6 overflow-y-auto py-6">
                                <div className="space-y-2">
                                    <Label htmlFor="merchant-list-search">Search</Label>
                                    <Input
                                        id="merchant-list-search"
                                        name="q"
                                        defaultValue={query}
